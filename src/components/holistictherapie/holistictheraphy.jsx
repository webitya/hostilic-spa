      ...
      >
        ...
        >
          ...
          <div className="p-4 flex flex-col flex-grow">
            ...
            <div className="flex items-center justify-between gap-1.5 text-gray-700 text-sm mb-2">
              <p className="flex items-center gap-1.5">
                <Clock className="w-4 h-4 text-teal-600" />
                {therapy.duration}
              </p>
              <p className="flex items-center gap-1.5 text-base font-bold text-teal-800">
            ...
            {therapy.tags && therapy.tags.length > 0 && (
              <div className="flex flex-wrap gap-1.5 mb-3 mt-auto">
                ...
                {therapy.tags.map((tag, tagIndex) => (
                  <span
                    key={tagIndex}
                    className="flex items-center gap-1 text-[10px] font-medium bg-teal-50 text-teal-800 px-2 py-0.5 rounded-full border border-teal-200"
                  >
            ...
            <div className="flex gap-2 mt-auto pt-3 border-t border-gray-100">
              ...
              <button
                className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 shadow-md hover:shadow-lg flex-1"
                onClick={(e) => {
        ...
        >
          ...
          <div className="w-full h-full [transform:scaleX(-1)]">
            <div className="p-4 flex flex-col h-full">
              <h3 className="text-lg font-bold text-teal-800 mb-1">{therapy.name}</h3>
              <p className="flex items-center gap-1.5 text-gray-700 text-sm mb-2">
                <Clock className="w-4 h-4 text-teal-600" />
                {therapy.duration}
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-2 border-t border-gray-100 pt-3 mt-auto">
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                  ...
                  <a
                    href="/contact"
                    className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 shadow-md hover:shadow-lg flex-1 sm:flex-none"
                    onClick={(e) => e.stopPropagation()} // Prevent card flip
                  >
                    Book Now
                  </a>
